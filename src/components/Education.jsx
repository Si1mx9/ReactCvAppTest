...
export default function Education({ onSave, savedEntries }) {
      ...
      <div className="section-header">
        <div className="section-title-group">
          ...
          <div>
            ...
            <div className="section-subtitle">Academic background & qualifications</div>
          </div>
        </div>
            ...
            <div key={index}>
              ...
              <div className="form-grid">
                <div className="form-group">
                  ...
                  <input name="school" type="text" placeholder="MIT" value={entry.school} onChange={(e) => handleChange(index, e)} />
                </div>
                <div className="form-group">
                  <label>Degree</label>
                  <input name="degree" type="text" placeholder="Bachelor's" value={entry.degree} onChange={(e) => handleChange(index, e)} />
                </div>
                <div className="form-group">
                  <label>Field of Study</label>
                  <input name="field" type="text" placeholder="Computer Science" value={entry.field} onChange={(e) => handleChange(index, e)} />
                </div>
                <div className="form-group">
                  <label>Start Date</label>
                  <input name="startDate" type="text" placeholder="Sep 2018" value={entry.startDate} onChange={(e) => handleChange(index, e)} />
                </div>
                <div className="form-group">
                  <label>End Date</label>
                  <input name="endDate" type="text" placeholder="Jun 2022 (or Present)" value={entry.endDate} onChange={(e) => handleChange(index, e)} />
                </div>
              </div>
            </div>
          ))}
            ...
            {entries.map((entry, index) => (
              <div key={index} className="entry-block">
                <div className="cv-entry-top" style={{ marginBottom: '6px' }}>
                  <div>
                    <div className="display-value">{entry.degree} {entry.field && `in ${entry.field}`}</div>
                    <div style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', marginTop: '2px' }}>{entry.school}</div>
                  </div>
